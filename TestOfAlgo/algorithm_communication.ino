...
/** The user interface and algorithm percieve the board
 * in "opposite" directions. Therefore, every byte returned
 * from the algorithm, has to be reversed
*/
void reverse_byte(byte * b)
{
   byte n = 0;

   for (int i = 0; i < 8; i++) {

      n |= (bool(*b & (0b10000000 >> i))) << i;
   }
